...
public class Settings {
    ...
    public static void setupValue() {
        ...
        DATABASE_SETTINGS_H2_FILE_NAME = configuration.getString("database.settings.h2.file-name");
        DATABASE_SETTINGS_MYSQL_HOST = configuration.getString("database.settings.mysql.host");
        DATABASE_SETTINGS_MYSQL_PORT = configuration.getString("database.settings.mysql.port");
        DATABASE_SETTINGS_MYSQL_NAME = configuration.getString("database.settings.mysql.name");
        DATABASE_SETTINGS_MYSQL_TABLE = configuration.getString("database.settings.mysql.table");
        DATABASE_SETTINGS_MYSQL_USER = configuration.getString("database.settings.mysql.user");
        DATABASE_SETTINGS_MYSQL_PASSWORD = configuration.getString("database.settings.mysql.password");
