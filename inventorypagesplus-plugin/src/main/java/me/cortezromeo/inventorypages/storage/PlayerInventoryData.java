...
public class PlayerInventoryData {
    ...
    public void saveCurrentPage() {
        ...
        if (!InventoryPages.useCreativeInventory || player.getGameMode() != GameMode.CREATIVE) {
    ...
    void clearPage(int page, GameMode gm) {
        if (gm != GameMode.CREATIVE) {
            ...
            if (!InventoryPages.useCreativeInventory) {
        ...
        if (gm != GameMode.CREATIVE) {
            ...
            for (int slotNumber = 0; slotNumber < 27; slotNumber++) {
                ...
                if (slotNumber == prevItemPos) {
                    ...
                    ItemStack itemStack = InventoryPages.nms.getItemStack(this.getItems(this.page).get(slotNumberClone));
                    if (itemStack != null) {
                        if (InventoryPages.nms.getCustomData(itemStack).equals(PlayerPageInventory.itemCustomData)) {
                            itemStack = null;
                        }
                    }
